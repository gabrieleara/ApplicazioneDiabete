...
public class AnalizzatoreDatiDiabetici {
    ...
    private static final int INDEX_GLUCOSIO_MEDIO = 0;
    private static final int INDEX_GLUCOSIO_SOPRA = 1;
    private static final int INDEX_GLUCOSIO_SOTTO = 2;
    
    private static final int INDEX_NUMERO_EVENTI = 0;
    private static final int INDEX_DURATA_EVENTI = 1;
    ...
    public static int[] produciStatisticheGlicemiche(ArrayList<GlicemiaRilevata> gc) {
        ...
        statistiche[TipoStatistica.GLUCOSIO_MEDIO.valore] =
                glucosioM[INDEX_GLUCOSIO_MEDIO];
        statistiche[TipoStatistica.GLUCOSIO_SOPRA_INTERVALLO.valore] =
                glucosioM[INDEX_GLUCOSIO_SOPRA];
        statistiche[TipoStatistica.GLUCOSIO_SOTTO_INTERVALLO.valore] =
                glucosioM[INDEX_GLUCOSIO_SOTTO];
        statistiche[TipoStatistica.EVENTI_GLUCOSIO_BASSO.valore] =
                glucosioB[INDEX_NUMERO_EVENTI];
        statistiche[TipoStatistica.DURATA_EVENTI_GLUCOSIO_BASSO.valore] =
                glucosioB[INDEX_DURATA_EVENTI];
    ...
    public static Collection<GlicemiaRilevata>
        analizzaGlicemiaMediaOraria(Collection<GlicemiaRilevata> glicemia) {
        List<GlicemiaRilevata> lista = new ArrayList<>(glicemia);
        ...
        do {
            ...
            List<GlicemiaRilevata> buoni = lista.stream()
                    .filter((GlicemiaRilevata gc) -> {
                        ...
                        // 08
                        return attuale.get(Calendar.HOUR_OF_DAY) == cs.get(Calendar.HOUR_OF_DAY)
...
/*
    ...
    05) Di nuovo sopra la soglia, l'intervallo è concluso all'iterazione
        ...
        05.1)   L'ultimo evento ha superato la mezzanotte della impostaDomenica: per
