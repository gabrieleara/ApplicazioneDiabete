...
public class GestoreDatiDiabetici {
	...
	public static java.util.Date ultimaSettimana(String paziente) {
		java.util.Date ultimaData = null;
		
		String query = "SELECT max(tempo) AS massimo FROM glicemia"
	...
	public static StatisticaInsulina[] insulinaSettimanale(String paziente, java.util.Date data) {
	...
	public static ArrayList<GlicemiaRilevata> glicemiaSettimanale(String paziente, java.util.Date data) {
